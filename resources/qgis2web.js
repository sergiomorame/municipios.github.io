...
map.getView().fit([-11074359.426957, 2171975.233089, -10954798.442277, 2234198.985750], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del agua</h2>';
        return titleElement;
    })(),
