...
lyr_Incidencias_3.set('fieldAliases', {'Marca temp': 'Marca temp', 'Tipo de pr': 'Tipo de pr', 'Nombre(s)': 'Nombre(s)', 'Apellido(s': 'Apellido(s', 'Telefono a': 'Telefono a', 'Municipio': 'Municipio', 'Colonia/Ba': 'Colonia/Ba', 'Avenida/Bo': 'Avenida/Bo', 'Numero ext': 'Numero ext', 'Numero Int': 'Numero Int', 'Codigo Pos': 'Codigo Pos', 'Manzana/Lo': 'Manzana/Lo', 'Lugar de r': 'Lugar de r', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Lat': 'Lat', 'Long': 'Long', 'Lon': 'Lon', 'Telefono': 'Telefono', 'fecha': 'fecha', 'layer': 'layer', 'path': 'path', });
...
lyr_Incidencias_3.set('fieldImages', {'Marca temp': 'TextEdit', 'Tipo de pr': 'TextEdit', 'Nombre(s)': 'TextEdit', 'Apellido(s': 'TextEdit', 'Telefono a': 'TextEdit', 'Municipio': 'TextEdit', 'Colonia/Ba': 'TextEdit', 'Avenida/Bo': 'TextEdit', 'Numero ext': 'TextEdit', 'Numero Int': 'TextEdit', 'Codigo Pos': 'TextEdit', 'Manzana/Lo': 'TextEdit', 'Lugar de r': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Lat': 'TextEdit', 'Long': 'TextEdit', 'Lon': 'TextEdit', 'Telefono': 'TextEdit', 'fecha': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
